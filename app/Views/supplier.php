                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-button-action">
                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#detailModal<?= $supplier['id_supplier'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-button-action">
